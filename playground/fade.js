...
/**
 * @name pi.fade
 * @desc fadeIn and fadeOut function
 * @params {String|DOMelement} elm element to fade
 * @params {Object} options
 * @params {String} [options.direction] in: fade in | out: fade out
 * @params {String} [options.ms] fade's ms | default:1000
 */
pi.fade = function (elm, options) {
    "use strict";
    elm = pi(elm);
    ...
    var opacity = (options.direction === 'in') ? 0 : 1;

    var timer = setInterval( function () {
        if (options.direction === 'in') {
            elm.style.display = "block";
            opacity += 50 / options.ms;
            if ( opacity >= 1) {
                clearInterval(timer);
                opacity = 1;
            }
